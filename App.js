      ...
      <header className={`${THEME.brownBg} relative overflow-hidden`}>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
            {LOGOS.main ? (
              <img src={LOGOS.main} alt="Логотип проекта" className="h-20 w-auto rounded-2xl shadow-lg" />
            ) : (
            ...
            <div>
              ...
              <p className="mt-2 text-stone-600 max-w-prose">{PROJECT_DESCRIPTION}</p>
            </div>
          </div>

          <div className="flex flex-wrap gap-3 mt-4 md:mt-0">
            <a href={LINKS.vk} target="_blank" rel="noreferrer">
              <Button className={`rounded-3xl shadow-md flex items-center gap-2 bg-stone-100 hover:bg-stone-300 border border-stone-300 ${THEME.buttonText}`}>
